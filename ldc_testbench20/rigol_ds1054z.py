...
class rigol_ds1054z:
	...
	def __init__(self, debug=False):
		...
		self.oscilloscope = resources.open_resource('USB0::0x1AB1::0x04CE::DS1ZA212706980::INSTR')
        #self.oscilloscope = resources.open_resource('ASRLCOM5::INSTR', u'ASRLCOM4::INSTR')
		self.debug = debug
